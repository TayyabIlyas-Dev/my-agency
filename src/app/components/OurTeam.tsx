    ...
    <div id='team'>
      <div className="font-[sans-serif]">
            ...
            <div className="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 gap-8 text-center mt-16 max-w-5xl max-lg:max-w-3xl max-md:max-w-xl mx-auto">
                <div>
                    <img src="/My pic.png" className="w-32 h-32 rounded-full inline-block" />

                    <div className="py-4">
                        <h4 className="text-gray-800 text-base font-bold">Tayyab</h4>
                ...
                <div>
                    <img src="/taha pic.png" className="w-32 h-32 rounded-full inline-block" />

                    <div className="py-4">
                        <h4 className="text-gray-800 text-base font-bold">Taha</h4>
                        <p className="text-gray-800 text-xs mt-1">Mern Stack Developer</p>
